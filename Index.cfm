	...
	<body>
		<div class="navbar navbar-nav navbar-fixed-top">
			...
			<cfif isDefined("Session.userName")>
				<button class="btn btn-primary nav-item col-xs-1" onClick="location.href='/Views/Profile.cfm'"><span class="glyphicon glyphicon-user" aria-hidden="true"> </span> <cfoutput>#Session.userName#</cfoutput></button>
